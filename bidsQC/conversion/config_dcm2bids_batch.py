...
path_toplevel = os.path.join(os.sep, "projects", "motorskill", "shared", "BIDSworkshopCoop") # folder that contains path_bidsdata and path_conversionfolder
...
path_bidsdata = os.path.join(os.sep, "projects", group, "shared", "BIDSworkshopCoop", "bids_data") # Where the niftis will be put
